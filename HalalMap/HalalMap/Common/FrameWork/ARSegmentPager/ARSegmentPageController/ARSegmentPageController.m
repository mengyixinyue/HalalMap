...
@property (nonatomic, strong) HMARSegmentView *hmSegmentView;
...
-(void)_baseConfigs
{
    ...
    self.hmSegmentView = [[HMARSegmentView alloc] initWithTitles:titles];
    self.hmSegmentView.delegate = self;
    [self.view addSubview:self.hmSegmentView];
...
-(void)_baseLayout
{
    ...
    //hmSegment
    self.hmSegmentView.translatesAutoresizingMaskIntoConstraints = NO;
    [self.view addConstraint:[NSLayoutConstraint constraintWithItem:self.hmSegmentView attribute:NSLayoutAttributeLeft relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeLeft multiplier:1 constant:0]];
    [self.view addConstraint:[NSLayoutConstraint constraintWithItem:self.hmSegmentView attribute:NSLayoutAttributeRight relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeRight multiplier:1 constant:0]];
    
    [self.view addConstraint:[NSLayoutConstraint constraintWithItem:self.hmSegmentView attribute:NSLayoutAttributeTop relatedBy:NSLayoutRelationEqual toItem:self.headerView attribute:NSLayoutAttributeBottom multiplier:1 constant:0]];
    
    [self.hmSegmentView addConstraint:[NSLayoutConstraint constraintWithItem:self.hmSegmentView attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:nil attribute:0 multiplier:1 constant:self.segmentHeight]];
}
...
-(void)_layoutControllerWithController:(UIViewController<ARSegmentControllerDelegate> *)pageController
{
    ...
    if (scrollView) {
        ...
        [self.view addConstraint:[NSLayoutConstraint constraintWithItem:pageView attribute:NSLayoutAttributeTop relatedBy:NSLayoutRelationEqual toItem:self.hmSegmentView attribute:NSLayoutAttributeBottom multiplier:1 constant:0]];
