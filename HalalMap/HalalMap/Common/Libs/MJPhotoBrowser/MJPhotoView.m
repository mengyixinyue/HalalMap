...
- (void)hide
{
    ...
    [UIView animateWithDuration:duration + 0.1 animations:^{
        CGRect rect = _photo.srcImageView.bounds;
        if (isIOS8) {
            rect = CGRectMake(0, rect.origin.x + 20, rect.size.width, rect.size.height);
        }
        _imageView.frame = [_photo.srcImageView convertRect:rect toView:nil];
