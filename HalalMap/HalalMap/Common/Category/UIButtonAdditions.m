...
{
    [self setBackgroundImage:[UIImage imageWithColor:color size:self.size] forState:state];
}
...
+ (UIButton *)buttonWithImage:(UIImage *)image
                       ...
                       action:(SEL)selector
{
    return [self buttonWithTitle:nil image:image titleColor:nil target:target action:selector];
}
