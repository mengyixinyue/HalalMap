...
- (void)popInShow
{
    CAKeyframeAnimation* animation0 = [CAKeyframeAnimation animationWithKeyPath:@"transform"];
    animation0.duration = 0.4;
    NSMutableArray *values0 = [NSMutableArray array];
    [values0 addObject:[NSValue valueWithCATransform3D:CATransform3DMakeScale(1.0, 1.0, 1.0)]];
    [values0 addObject:[NSValue valueWithCATransform3D:CATransform3DMakeScale(1.5, 1.5, 1.0)]];
    animation0.values = values0;
    ...
    [values1 addObject:[NSValue valueWithCATransform3D:CATransform3DMakeScale(1.0, 1.0, 1.0)]];
    [values1 addObject:[NSValue valueWithCATransform3D:CATransform3DMakeScale(1.0, 1.0, 1.0)]];
    animation1.values = values1;
    animation1.beginTime = 0.5;
    
    CAAnimationGroup *animationGroup = [CAAnimationGroup animation];
    animationGroup.duration = 0.5 + 3;
    ...
    [self.layer addAnimation:animationGroup forKey:@"tongtong"];
}
...
- (void)zan
{
    ...
    [self.layer addAnimation:animation forKey:@"zan"];
}
...
//    [values addObject:[NSValue valueWithCATransform3D:CATransform3DMakeScale(1.0, 1.0, 1.0)]];
    ...
    [self.layer addAnimation:animation forKey:@"peng"];
}
...
- (void)pengpeng
{
    ...
    [self.layer addAnimation:animation forKey:@"pengpeng"];
}
